...
DATE=`date "+%Y%m%d"`
OUT_DIR=/path/to/minimap2/${MINIMAP2_VERSION}/hg38/${SAMPLE_ID}/${DATE}
...
#test -e ${SAMPLE_DATA_DIR}/hac_basecall_${SAMPLE_ID}.log || die "Sample ${SAMPLE_ID} has not been basecalled yet in hac model. Exiting."
